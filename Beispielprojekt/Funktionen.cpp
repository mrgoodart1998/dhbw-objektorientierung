...
double Funktionen::get_abstand(double ob1_breite, double ob1_hoehe, double ob2_breite, double ob2_hoehe, double ob1_posx, double ob1_posy, double ob2_posx, double ob2_posy) const
{
	double abstand_x;
